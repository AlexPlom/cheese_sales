...
Use Bulgarian copy and euro prices. The visual language is clean editorial neo-brutalism: oversized condensed type, mono utility text, hard borders, warm paper, charcoal, restrained primary accents, a custom screen-printed cheese hero illustration, and traditional product photography. Motion is limited to subtle ticker and hover transitions and respects `prefers-reduced-motion`.
